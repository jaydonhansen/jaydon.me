...
function App() {
  ...
  return (
    <div className="App">
      <div className="flex absolute inset-0 bg-slate-200 dark:bg-slate-900 transition duration-1000">
        ...
        <div className="fixed top-2 left-2">
          <button
            ...
            onClick={() =>
              window.open("https://www.linkedin.com/in/jaydonhansen/")
            }
          >
            <svg
          ...
          inline-flex items-center rounded"
            onClick={() => window.open("https://github.com/jaydonhansen")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
