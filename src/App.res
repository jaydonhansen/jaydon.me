...
let make = () => {
  ...
  let numel = "/img/numel.gif"

  <div className={currentTheme}>
    <div
      className="f-col h-screen p-4 items-center bg-slate-200 dark:bg-slate-900 transition duration-250">
      <div className="flex">
        <div className="flex-grow ml-2 h-8 space-x-2 align-middle">
          <a
            className="font-semibold inline-flex items-center space-x-2 rounded-full text-slate-900 dark:text-slate-200"
            href="https://www.linkedin.com/in/jaydonhansen/"
            rel="noreferrer"
            target="_blank">
            <svg
              className="w-5 h-5 fill-slate-900 dark:fill-slate-200"
              role="img"
              viewBox="0 0 256 256"
          ...
          <a
            className="bg-none p-2 font-semibold text-slate-900 dark:text-slate-200
        ...
        <div
          className="mr-2 w-32 m-auto align-middle text-right text-slate-900 dark:text-slate-200">
          <button onClick>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
        ...
        <div className="flex h-full w-full justify-center items-center">
          ...
          dark:bg-slate-800 border-slate-400 dark:border-slate-200 dark:hover:bg-slate-600">
            ...
            bg-slate-200 p-4 rounded-xl border-2 border-slate-400 dark:border-slate-200 dark:bg-slate-700">
              ...
              body is a seething cauldron of boiling magma.`->React.string}
            </p>
          </div>
        </div>
      </div>
